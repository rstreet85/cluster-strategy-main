...
public class NormalizationContext {
    ...
    /**
     * Method to set data normalization method to use.
     * 
     * @param strat The desired distance measure strategy.
     */
    public void setNormalizationStrategy(NormalizationStrategy strat) {
        strategy = strat;
    }
    
    /**
     * Method to get normalized data using the specified strategy.
     * 
     ...
     */
    /*
    public double normalizeData(double[] pointA, double[] pointB) {
